...
public class MovieprocessorApplicationTests {
	...
	public void testMovieProcessor() {	
		try {
			assertEquals("{\"DVD_Title\": \"WWE%3A+30+Years+Of+SummerSlam\", \"UPC\": \"6.5119195694e+1\"}", new MovieProcessor().transform("\"WWE: 30 Years Of SummerSlam\",\"WWE Home Video\",,\"Out\",\"5.1\",\"LBX, 16:9\",$24.98,\"NR\",\"2017\",\"Special Interest\",\"1.78:1\",\"6.5119195694e+1\",8/28/2018 0:00:00,312200,8/28/2018 0:00:00,\"1\"" ));
